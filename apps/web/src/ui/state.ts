...
const MAP: Record<InstanceState, StateUi> = {
  ...
  starting: { colorVar: '--color-state-starting', label: 'Uruchamianie', symbol: '🔵' },
  stopping: { colorVar: '--color-state-stopping', label: 'Zatrzymywanie', symbol: '🟡' },
  stopped: { colorVar: '--color-state-stopped', label: 'Zatrzymany', symbol: '⚪' },
  error: { colorVar: '--color-state-error', label: 'Błąd', symbol: '🔴' },
  crashed: { colorVar: '--color-state-crashed', label: 'Awaria', symbol: '🔴' },
  unknown: { colorVar: '--color-state-unknown', label: 'Nieznany', symbol: '❓' },
};
