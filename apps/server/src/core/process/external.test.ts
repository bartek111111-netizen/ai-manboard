...
describe('parseCliArgs', () => {
  it('parses --key value and --key=value forms, skipping argv[0]', () => {
    ...
    expect(args['model']).toBe('/mnt/dane/Odysseus/models/Qwen3.8-27B-Ridge-3.7bpw.gguf');
...
describe('scanEngineProcesses', () => {
  it('finds engine processes by argv[0] basename and reads their args', () => {
    ...
    try {
      writeCmdline('100', '/home/bat/llama.cpp/build/bin/llama-server\x00--model\x00/m/x.gguf\x00--port\x008080\x00');
